...
const MyParcels = () => {
  ...
  const { data: parcels = [], refetch } = useQuery({
    ...
    // query won't start until email comes.
    enabled: !!user?.email,
  });

  //  delete
  const handldParcelDelete = (id) => {
    Swal.fire({
      title: "Are you sure?",
            ...
            {parcels.map((parcel, index) => (
              <tr key={parcel._id}>
                ...
                <td>
                  ...
                  <button className="btn btn-squere hover:bg-primary mx-2">
                    <FiEdit></FiEdit>
                  </button>
                  <button
                    onClick={() => handldParcelDelete(parcel._id)}
                    className="btn btn-squere hover:bg-primary"
                  >
                    <FaTrashCan />
                  </button>
                </td>
